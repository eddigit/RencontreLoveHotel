    ...
    <MainLayout>
      <main className='min-h-screen px-4 py-12'>
        <article className='mx-auto max-w-3xl space-y-6'>
          ...
          <section className='space-y-3'>
            <h2 className='text-xl font-semibold'>Détection anti-sollicitation</h2>
            <p>Les messages et contenus publiés peuvent faire l’objet d’une détection automatisée ciblée des coordonnées hors plateforme et des indices de sollicitation sexuelle rémunérée. Les alertes sont réexaminées humainement par les personnes habilitées.</p>
          </section>
          <section className='space-y-3'>
