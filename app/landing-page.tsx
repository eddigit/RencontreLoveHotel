...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#120821] overflow-x-hidden">
      {/* Hero Section */}
      <section id='concept' className="py-8 md:py-16 relative overflow-hidden">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-3 md:space-y-4">
              ...
              <p className="text-gray-300 text-base md:text-lg max-w-xl">
                ...
                nos Love Rooms, spas et événements communautaires.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 mt-4 md:mt-0">
            ...
            <div className="space-y-3 md:space-y-4 mt-6 md:mt-8">
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-lg shadow-purple-900/30">
                <Image
                  src="/paris-event-masquerade.png"
                  alt="Soirée rencontres authentiques à Paris"
                  fill
                  className="object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1a0d2e]/80 via-transparent to-transparent"></div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 md:p-4 bg-[#1a0d2e]/50 backdrop-blur-sm">
                  <p className="text-base md:text-lg font-bold text-white">SOIRÉES RENCONTRES</p>
                  <p className="text-xs md:text-sm text-white/80">Événements authentiques à Paris</p>
                </div>
              </div>
      ...
      {/* Features Section */}
      <section id='hotels' className="py-12 md:py-16 relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            <div className="bg-gradient-to-br from-[#2d1155]/70 to-[#3d1155]/50 backdrop-blur-sm p-6 rounded-2xl border border-purple-800/20 shadow-lg shadow-purple-900/20">
              ...
              <p className="text-gray-300 text-sm md:text-base">
                Love Hôtel vous connecte à une communauté réelle, autour du Love Hôtel Pigalle et du Love Hôtel Châtelet.
              </p>
            </div>
      ...
      <section id='communaute' className="py-10 md:py-14 relative overflow-hidden">
      ...
      {/* CTA section */}
      <section id='experiences' className="py-8 md:py-16">
        <div className="container px-4">
          <div className="bg-gradient-to-r from-[#3d1155] to-[#ff3b8b] rounded-3xl p-6 md:p-12 flex flex-col lg:flex-row items-center justify-between shadow-lg shadow-purple-900/30">
            <div className="lg:w-2/3 mb-6 lg:mb-0">
              ...
              <p className="text-base md:text-xl text-white/90">
                 Apéros jacuzzi, RIDEAUX OUVERTS et soirées parisiennes dans un cadre respectueux.
              </p>
            </div>
            <div>
              <Button
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            <div className="md:w-1/2 text-center md:text-left">
              <p className="text-white text-lg md:text-xl font-medium mb-1">
                Club Love Hotel, les expériences de la communauté
              </p>
              <h2 className="text-white text-3xl md:text-5xl font-black tracking-tight mb-2 drop-shadow-lg">
                VIVEZ DES <span className="text-[#ff3b8b]">RENCONTRES AUTHENTIQUES</span>
              </h2>
              <p className="text-white/90 text-lg md:text-2xl font-medium">
                Découvrez les prochains événements Love Hotel.
              </p>
            </div>
            <div className="md:w-1/2 flex items-center justify-center md:justify-end">
              <div className="flex flex-col space-y-3">
                ...
                <Button variant="outline" className="border-white/30 text-white hover:bg-white/10" asChild>
                  <Link href="/community-safety">Notre charte</Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      <section className="py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className='grid gap-4 md:grid-cols-3'>
            <Image src='/apero-jacuzzi-rencontre.jpg' alt='Apéros jacuzzi' width={640} height={420} className='rounded-2xl object-cover' />
            <Image src='/paris-event-limousine.png' alt='Événement parisien' width={640} height={420} className='rounded-2xl object-cover' />
            <Image src='/rideaux-ouverts-rencontre.jpg' alt='Rideaux ouverts' width={640} height={420} className='rounded-2xl object-cover' />
          </div>
        </div>
      </section>

      {/* Footer */}
      <section className="border-t border-[#2d1155] mt-8 md:mt-12 py-8 md:py-12">
        <div className="container px-4">
